...
(possible-fact (name "Daewoo Matis"))
...
(not (exists (fact (name "Daewoo Matis"))))
=>
(assert (fact (name "Daewoo Matis")))
(assert (sendmessage "коробка передач МКПП, класс A (мини -> Daewoo Matis")))
(defrule rule80
(fact (name "коробка передач АКПП"))
(fact (name "класс A (мини"))
(not (exists (fact (name "Daewoo Matis"))))
=>
(assert (fact (name "Daewoo Matis")))
(assert (sendmessage "коробка передач АКПП, класс A (мини -> Daewoo Matis")))
(defrule rule81
(fact (name "коробка передач МКПП"))
